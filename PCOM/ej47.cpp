// ej47.cpp : Este archivo contiene la función "main". La ejecución del programa comienza y termina ahí.
//
...
bool resuelveCaso() {
    ...
    line barraIz(abajoIz, arribaIz);
    line barraDer(abajoDer, arribaDer);
    ...
    for (int i = 0; i < flaps;i++) {
        ...
        if (i % 2 == 0) { // Pegado a la izquierda
            ...
            inter(flapL, barraDer,sol);

            double distan = dist(sol, aux);
